...
plot_learning_curve("exp/lstm_8570_1000_5","Full URNN compared to LSTM, 1600 parameters, 8 Categories, T=1000",flag_plot_train=True,T=1000)

draw_graph_file("exp/LSTM_param_69253.txt")
