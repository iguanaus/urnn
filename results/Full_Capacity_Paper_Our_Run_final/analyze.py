...
#memory_problem_final_LSTM_adhoc_LSTM_nhidden40_t1000
    urnn_file="memory_problem_final_complex_RNN_full_complex_RNN_nhidden65_t"+str(t)
    lstm_file="memory_problem_final_LSTM_adhoc_LSTM_nhidden40_t"+str(t)

    bengio_file="memory_problem_final_complex_RNN_adhoc_complex_RNN_nhidden128_t"+str(t)
    ...
    ax = plot_learning_curve(urnn_file,"Full URNN T = "+str(t)+", 8 Categories, N=65",flag_plot_train=True,T=t,plotbaseline=True)
    ax.set_title(title)
