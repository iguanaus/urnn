...
for t in [200]:
    title = "Time lag = "+str(t) + ", LSTM theano versus Tensorflow"

    urnn_file="LSTM_T=200_8529.txt"

    secFile = "oldtest_mem_prob"

    ax = plot_learning_curve(secFile,"LSTM, Theano T = 200",flag_plot_train=True,T=200,plotbaseline=True)

    draw_graph_file(urnn_file)

    
    # ax = plot_learning_curve(urnn_file,"Full URNN T = "+str(t)+", 8 Categories, N=65",flag_plot_train=True,T=t,plotbaseline=False)
