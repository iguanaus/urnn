...
for t in [1000]:
    ...
    lstm_file="memory_problem_adhoc_LSTM_learning_0.001_ncats_5_nhidden40_t"+str(t)

    bengio_file="memory_problem_adhoc_URNN_learning_0.001_ncats_5_nhidden128_t"+str(t)
